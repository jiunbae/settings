...
export ACMEDNS_USERNAME="904f00d3-754c-47e5-b607-27ce268489db"
export ACMEDNS_PASSWORD="mYDphdPVtL5OOA1mteEUGb9wq2vCorWNohEUvIw0"
export ACMEDNS_SUBDOMAIN="4aad7165-3589-4445-83f1-b8ac870215ca"

certs_src_dir="/usr/syno/etc/certificate/system/default"

/usr/local/share/acme.sh/acme.sh --renew --force --dns dns_acmedns \
	-d jiun.dev -d *.jiun.dev \
